...
# ---------------------------------------------------------------------------
import sys as _sys
_KG_CODE_DIR = Path(__file__).resolve().parent
_sys.path.insert(0, str(_KG_CODE_DIR))
from build_kg import _find_latest_run_dir, PROJECT_ROOT, KG_DIR  # noqa: E402

OUT_DIR = KG_DIR / "cluster_metrics_out"
METADATA_PATH = _find_latest_run_dir(PROJECT_ROOT) / "subset085" / "inputs" / "enriched_gs_metadata_subset085_human.csv"
